...
Officer: 3977425
CaseNum: 402-3-68298908-3977425
...
function draw()
{
	...
	} else if (det.locationY > 500 && det.locationX > 192){
		det.speedX = -mainSpeed;
		det.speedY = 0;
	} else if (det.locationX > 190 && det.locationY > 390){
		det.speedX = 0;
		det.speedY = -mainSpeed;
	} else if ((det.locationY < 390 && det.locationY > 373) && det.locationX < 571){
		det.speedX = mainSpeed;
		det.speedY = 0;
	} else if (det.locationX > 569 && det.locationY > 262){
		det.speedX = 0;
		det.speedY = -mainSpeed;
	} else if ((det.locationY < 260 && det.locationY > 248) && det.locationX > 316){
		det.speedX = -mainSpeed;
		det.speedY = 0;
	} else if (det.locationX < 318 && det.locationY > 135){
		det.speedX = 0;
		det.speedY = -mainSpeed;
	} else if ((det.locationY < 137 && det.locationY > 124) && det.locationX < 817){
		det.speedX = mainSpeed;
		det.speedY = 0;
	} else if (det.locationX > 815 && det.locationY > 71){
		det.speedX = 0;
		det.speedY = -mainSpeed;
	} else if (det.locationY < 73 && det.locationX > 129){
		det.speedX = -mainSpeed;
		det.speedY = 0;
	} else if (det.locationX < 131 && det.locationY > 0){
		det.speedX = 0;
		det.speedY = -mainSpeed;
	}
