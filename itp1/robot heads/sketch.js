...
function draw() {
	...
	// makre them bounce off each other
	if (robot1_x > robot2_x - 100 && robot1_x < robot2_x + 100 && robot1_y > robot2_y - 100 && robot1_y < robot2_y + 100) {
		...
		// move the robots
		robot1_x += direction * 10;
		robot2_x -= direction * 10;
